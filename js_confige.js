...
if (typeof HYMN_CDN === 'undefined') {
  var HYMN_CDN = 'https://cdn.jsdelivr.net/gh/heeyong-jo/bible-data@main';
}
...
// ==================== 전역 변수 내보내기 ====================
window.OT_BOOKS = OT_BOOKS;
window.NT_BOOKS = NT_BOOKS;
window.ADMIN_ACCOUNTS = ADMIN_ACCOUNTS;
window.FB_KEYS = FB_KEYS;
window.BIBLE_CDN = BIBLE_CDN;
window.HYMN_CDN = HYMN_CDN;
